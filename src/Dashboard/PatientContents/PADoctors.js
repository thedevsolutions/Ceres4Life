            ...
            <div className="d-block d-md-flex justify-content-between align-items-center">
              <div className="d-flex align-items-center">
                ...
                <div className="d-profile-description ml-4">
                  ...
                  <p>
                    <span><GiStarFormation /></span> PMC Verified
                  </p>
                </div>
              </div>
              <div className="chat-consultation">
                <div className="text-center position-relative">
                  <div className="down-arrow"><FiChevronDown fontSize={"25px"} color={"#72D3D3"} /></div>
                  <div className="my-2">
                  <button className="btn btn-primary px-10">Chat Now</button>
                  <div className="my-2"/>
                  <button className="btn btn-primary-outline px-4">
                    Book a Consultation
                  </button>
                  </div>
                  <div className="down-arrow"><FiChevronUp fontSize={"25px"} color={"#72D3D3"} /></div>
                </div>
              </div>
            </div>
          </div>
